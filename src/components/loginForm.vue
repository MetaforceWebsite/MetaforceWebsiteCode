                ...
                <div class="q-ma-md">
                    <q-form ref="formCmp">
                        ...
                        <template v-if="!isSignIn">
                            <q-input v-model="form.firstname" label="First Name" class="q-mb-md" :rules="nameRules" lazy-rules="ondemand" autofocus outlined hide-bottom-space>
                        ...
                        <q-input v-model="form.email" label="Email address" type="email" class="q-mb-md" :rules="emailRules" lazy-rules="ondemand" autofocus outlined hide-bottom-space>
...
export default {
    data () {
        return {
            ...
            form: { firstname: "", lastname: "", email: "18210473070@163.com", verificationCode: "720223" },
